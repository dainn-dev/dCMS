...
3. **Rewrite MEMORY.md:** Fresh, concise (dưới 200 lines) — giữ lại: current state, in-progress, recent decisions
4. **Update decisions.md:** Append any new architectural decisions
